...
if ($campo=mysqli_fetch_array($carregador)) {
	...
	<h4 class="tamanho"; >Digite nova senha</h4>
 	<form action="atualiza_senha_hospital.php" method="post">
 		<label for="senha" class="tamanho">Senha</label>
		<br>
		<input type="password" class="tamanho" name="senha" id="senha" placeholder="Digite nova senha" maxlength="8" required>
		<br><br>
		
		<label for="confsenha" class="tamanho">Confirme a senha</label>
		<br>
		<input type="password" class="tamanho" name="confsenha" id="confsenha" placeholder="Confirme a senha" maxlength="8" required onblur="verifica_senha()">
		<br><br>
